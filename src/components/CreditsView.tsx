...
const ALUNOS = [
  { name: "Nome do Aluno 1", role: "Desenvolvedor Fullstack" },
  { name: "Nome do Aluno 2", role: "Designer UI/UX" },
  { name: "Nome do Aluno 3", role: "Pesquisador de Conteúdo" },
];
    ...
    <div className="w-full min-h-full flex flex-col items-center justify-start p-8 md:p-16 overflow-y-auto bg-[#0F1014]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-5xl">
        ...
        >
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h3 className="text-2xl font-bold text-white">Equipe de Desenvolvimento</h3>
      ...
      >
        <p className="text-white/30 text-sm flex items-center justify-center gap-2">
          Desenvolvido com <Heart className="w-4 h-4 text-red-500 fill-red-500" /> para a educação pública de qualidade.
        </p>
        <div className="mt-4 flex items-center justify-center gap-4 text-white/20 text-xs">
          <span className="flex items-center gap-1"><Code2 className="w-3 h-3" /> v1.0.0</span>
          <span>•</span>
